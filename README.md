...
Apart from being a cool project, I also program this in a very special style.

My goal is

- Create a complex, distributed, event driven, reactive microservice, production-grade application
- 100% generated by AI
- 100% recorded every step of the way (planned 100+ hours) --> YouTube series here: https://bit.ly/46ZWhvm
- Detailed investigation and lessons learned
